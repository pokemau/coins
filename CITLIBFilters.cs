...
namespace ImageProcess2
{
	...
	public class BitmapFilter
	{
		...
		public static bool Invert(ref Bitmap b)
		{
		...
		public static bool GrayScale(ref Bitmap b)
		{
			// GDI+ still lies to us - the return format is BGR, NOT RGB.
            BitmapData bmData = b.LockBits(new Rectangle(0, 0, b.Width, b.Height), ImageLockMode.ReadWrite, PixelFormat.Format24bppRgb);
		...
		public static bool Smooth(ref Bitmap b, int nWeight /* default to 1 */)
		{
		...
		public static bool GaussianBlur(ref Bitmap b, int nWeight /* default to 4*/)
		{
			ConvMatrix m = new ConvMatrix();
			m.SetAll(1);
			m.Pixel = nWeight;
		...
		public static bool EdgeDetectQuick(ref Bitmap b)
		{
			ConvMatrix m = new ConvMatrix();
			m.TopLeft = m.TopMid = m.TopRight = -1;
			m.MidLeft = m.Pixel = m.MidRight = 1;
		...
		public static bool EdgeDetectConvolution(ref Bitmap b, short nType, byte nThreshold)
		{
			ConvMatrix m = new ConvMatrix();
		...
		public static bool EdgeDetectDifference(ref Bitmap b, byte nThreshold)
		{
			// This one works by working out the greatest difference between a pixel and it's eight neighbours.
			// The threshold allows softer edges to be forced down to black, use 0 to negate it's effect.
			Bitmap b2 = (Bitmap) b.Clone();
